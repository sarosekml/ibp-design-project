...
| Файл | Что содержит |
|---|---|
| `hub.js` (корень) | Реестр хаба: одна запись на приложение. Новое приложение регистрируется здесь и файлом `app.json` с треком |
...
(`track: "rnd"`) и запись в `hub.js` (`group: 'concepts'`). Строка
