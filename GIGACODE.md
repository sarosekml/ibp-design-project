...
Каждое приложение — каталог с `app.json` в `apps/` (концепты — `apps/<раздел>/drafts/<id>/`) одной формы: `app.json` с треком,
...
- **`rnd`** — **концепты и новые разработки**, в том числе на новых
  ...
  **Сюда агент кладёт собранные экраны**: `apps/<раздел>/drafts/<Имя>/pages/<Имя>.html` +
  `<Имя>.screen.md`.
...
Результат сборки — приложение трека `rnd`: `apps/<раздел>/drafts/<Имя>/pages/<Имя>.html` +
`<Имя>.screen.md`, у нового приложения — `apps/<раздел>/drafts/<Имя>/app.json`
