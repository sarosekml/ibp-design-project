...
Каждое приложение — модуль раздела `apps/<раздел>/<имя>-app/` или концепт
`apps/<раздел>/drafts/<имя>/`, форма одна: `app.json` с треком, экраны и их
...
`/resume <Задача>` (файл `<приложение>/<Задача>.handoff.md`).