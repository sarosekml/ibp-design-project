...
/* ============================================================
   ...
   Запуск:
     node apps/post/tools/assemble.mjs                 — собрать все источники направления
     node apps/post/tools/assemble.mjs <источник> […]   — собрать указанные
...
/* Источники направления: любой .html внутри apps/post/ с меткой <ds-include>.
