...
| `/panel <приложение> [on · flows · comments · off]` | панель прототипа: включить, описать сценарии показа, взять комментарии в работу, выключить |
...
- `Alt+Shift+P` на любой странице прототипа — шторка справа (на macOS Alt — это
  Option);
- **User Flows** — сценарии показа блок-схемой: клик по шагу открывает нужную
  страницу и проигрывает действия до этого места, мини-плеер и
  `Alt+Shift+→ / ←` листают шаги — путь не приходится проходить руками;
- **Комментарии** — правки к прототипу с привязкой к странице и шагу; они
